...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="notifications.php" class="w3-bar-item w3-button w3-padding"><i class="icon-envelope fa-fw"></i>  Notification</a>
...
function fetch_Admins_notifications(){
  $.ajax({
    url:'../controllers/fetch_Admins_notifications.php',
    method:'POST',
